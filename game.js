...
(function() {
    ...
    function preload() {
        ...
        text = game.add.text(game.camera.x, game.camera.height / 2, 'loading...', {
            fill: '#ffffff'
        });
    ...
    function textinit() {
        ...
        if (gamestate === inmenu) {
            ...
            nidish = game.add.text(gamewidth / 3, 0, "Nidish", {
                font: "80px Courier New",
                fill: "#c2a83e",
                align: "center"
            });

            playgame = game.add.text(0, 100, "Play", {
                font: "65px Courier New",
                fill: "#c2a83e",
                align: "center"
            });

            github = game.add.text(0, 250, "Github", {
                font: "65px Courier New",
                fill: "#c2a83e",
                align: "center"
            });

            fullscreen = game.add.text(0, 400, "Fullscreen", {
                font: "65px Courier New",
                fill: "#c2a83e",
                align: "center"
            });
        ...
        if (gamestate === win) {
            ...
            nidish = game.add.text(gamewidth / 10, 0, whowon + " Wins", {
                font: "80px Courier New",
                fill: "#c2a83e",
                align: "center"
            });

            playgame = game.add.text(0, 100, "Back to menu", {
                font: "65px Courier New",
                fill: "#c2a83e",
                align: "center"
            });

            github = game.add.text(0, 250, "Rematch", {
                font: "65px Courier New",
                fill: "#c2a83e",
                align: "center"
            });
    ...
    let playerstates = (player, otherplayer) => {
        ...
        switch (player.curstate) {
            ...
            case idle:
                ...
                break;
            case normalattack:
                player.animations.play('normalattack');
                ...
                break;
            case blocking:
                player.animations.play('blocking');
                break;
            case exhaustedidle:
                player.animations.play('exhaustedidle');
                break;
            case airattackdown:
                player.animations.play('airattackdown');
            ...
            case ducking:
                ...
                break;
            case dead:
                player.animations.play('deadanimation').onComplete.add(function() {
                    player.respawn();
                }, this);
                break;
            default:
        ...
        switch (player.curstate) {
            ...
            case ducking:
                break;
            default:
                player.body.setSize(spritesizew / Math.abs(player.scale.x), spritesizeh / Math.abs(player.scale.y), 0, 0);
        }
    ...
    let playerblockedhit = (otherplayer) => {
        ...
        if (otherplayer.blockedamount >= 3) {
            switch (otherplayer.scale.x) {
                case -playerscalew:
                    outofblocks(otherplayer, -playerscalew);
                    break;
                case playerscalew:
                    outofblocks(otherplayer, playerscalew);
                    break;
    ...
    let throwthesword = (player) => {
        ...
        switch (player.scale.x) {
            case -playerscalew:
                throwdirection(player, thesword, -playerscalew);
                break;
            case playerscalew:
                throwdirection(player, thesword, playerscalew);
                break;
    ...
    let updateweaponposition = (player) => {
        ...
        switch (player.sword) {
            case sword1:
                setswordposition(player, sword1);
                break;
            case sword2:
                setswordposition(player, sword2);
                break;
            default:
        }
        ...
        switch (player.shield) {
            case shield1:
                setshieldposition(player, shield1);
                break;
            case shield2:
                setshieldposition(player, shield2);
                break;
            default:
        }
    ...
    let setswordposition = (player, sword) => {
        ...
        switch (player.curstate) {
            case walking:
                setswordwalk(player, sword);
                break;
            case idle:
                setswordidle(player, sword);
                break;
            case normalattack:
                setswordnormalattack(player, sword);
                break;
            case blocking:
                setswordblocking(player, sword);
                break;
            case exhaustedidle:
                setswordexhaustedidle(player, sword);
                break;
            case airattackdown:
                setswordairattackdown(player, sword);
                break;
            case jumping:
                setswordjumping(player, sword);
                break;
            case falling:
                setswordfalling(player, sword);
                break;
            case ducking:
                setswordducking(player, sword);
                break;
            case dead:
                setsworddying(player, sword);
                break;
            default:
    ...
    let setshieldposition = (player, shield) => {
        ...
        switch (player.curstate) {
            case walking:
                setshieldwalk(player, shield);
                break;
            case idle:
                setshieldidle(player, shield);
                break;
            case normalattack:
                setshieldnormalattack(player, shield);
                break;
            case blocking:
                setshieldblocking(player, shield);
                break;
            case exhaustedidle:
                setshieldexhaustedidle(player, shield);
                break;
            case airattackdown:
                setshieldairattackdown(player, shield);
                break;
            case jumping:
                setshieldjumping(player, shield);
                break;
            case falling:
                setshieldfalling(player, shield);
                break;
            case ducking:
                setshieldducking(player, shield);
                break;
            case dead:
                setshielddying(player, shield);
                break;
            default:
                shield.x = player.x - player.width / 4;
                shield.y = player.y;
                shield.angle = 0;
        }
